...
System.out.println("\n" + "Wrong Customer Number or Pin Number." + "\n");
	...
	switch(selection) {
	case 1:
	System.out.println("Checking Acccount Balance: "+moneyFormat.format(getCheckingBalance()));
	getAccountType();
	break;
	...
	switch(selection) {
	case 1:
	System.out.println("Saving Acccount Balance: "+ moneyFormat.format(getSavingBalance()));
	getAccountType();
	break;
